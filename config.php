...
$config['LicenseName'] = 'Nahireal';
$config['LicenseKey'] = 'AAMST39DL9LB6W11F2DT9ABXGQY6S3PY';
...
$config['ResourceType'][] = Array(
    ...
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions' => '');

$config['ResourceType'][] = Array(
    'name' => 'projects',
    'url' => $baseUrl . 'projects',
    'directory' => $baseDir . 'projects',
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
    'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
    ...
    'maxSize' => 0,
    'allowedExtensions' => 'doc,docx,xltx,txt,zip,rar,pdf,xlsx',
    'deniedExtensions' => '');

$config['ResourceType'][] = Array(
    'name' => 'house',
    'url' => $baseUrl . 'house',
    'directory' => $baseDir . 'house',
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
    'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
    'name' => 'radio',
    'url' => $baseUrl . 'radio',
    'directory' => $baseDir . 'radio',
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,mp3,mkv,ogg',
    'deniedExtensions' => '');

$config['ResourceType'][] = Array(
    'name' => 'advertisement',
    'url' => $baseUrl . 'advertisement/images',
    'directory' => $baseDir . 'advertisement/images',
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,mp3,mkv,ogg,swf',
    'deniedExtensions' => '');
