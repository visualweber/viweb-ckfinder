...
class CKFinder_Connector_CommandHandler_FileUpload extends CKFinder_Connector_CommandHandler_CommandHandlerBase {
    ...
    public function sendResponse() {
        ...
        $sUnsafeFileName = CKFinder_Connector_Utils_FileSystem::strAlias(CKFinder_Connector_Utils_Misc::mbBasename($uploadedFile['name']));
        ...
        while (true) {
            $sFileName = CKFinder_Connector_Utils_FileSystem::alias($sFileName);
